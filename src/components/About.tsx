  ...
  return (
    <section id="about" className="content-section section-wrap">
      <SectionHeading
        ...
        title="Curiosity is my starting point."
      />
      <div className="about-grid">
        <div className="about-copy">
          <p>
            ...
            at Avanade, developing proof-of-concept solutions using Microsoft AI
            technologies, with previous frontend development experience at YARSI
            Hospital.
          </p>
          <p>
          ...
          <a className="text-link" href="#education">
            Explore my journey <FiArrowUpRight />
          </a>
        </div>
        <div className="profile-panel">
          ...
          <h3>Falah Andhesryo</h3>
          <p className="muted location">
            <FiMapPin /> East Jakarta, Jakarta
          </p>
          <dl className="profile-details">
            <div>
              <dt>EMAIL</dt>
              <dd>
                <a href="mailto:falahand@gmail.com">falahand@gmail.com</a>
              </dd>
            </div>
            <div>
              <dt>PHONE</dt>
              <dd>
                <a href="tel:+6285219243377">+6285219243377</a>
              </dd>
            </div>
            <div>
              <dt>FOCUS</dt>
              <dd>AI · Software · IoT</dd>
            </div>
          </dl>
